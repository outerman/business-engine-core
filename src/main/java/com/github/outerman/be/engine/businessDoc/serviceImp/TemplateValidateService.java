...
//    }
    ...
    @Override
    public String validateTemplateByMockDoc(SetOrg setOrg, String businessCode, ITemplateProvider templateProvider, IFiDocProvider fiDocProvider, ITestGenerateProvider testGenerateProvider) {
